...
from Drawing_AutoCad.Steel_Pipe_Bailey_Platform_CAD.Platform_MCT_format_CAD import build_mct_from_ui
...
def All(app,acadapp):   
    ...
    zd_f2_section_cad = {}
    zd_section_cad = {}
    zd_f1_section_name = None
    zd_f2_section_name = None
    zd_section_name = None
    ...
    # not_has_brake = app.tab_components.use_brake_var.get()
    # if not not_has_brake:
    #     if_ZD = True
    # else:
    if_ZD = False
    print("标注样式生成完成")
